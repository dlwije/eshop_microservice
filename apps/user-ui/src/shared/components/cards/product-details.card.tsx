        ...
        <div className="w-full flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 md:pl-8 mt-6 md:mt-0">
            ...
            <div className="border-b relative pb-3 border-gray-200 flex items-center justify-between">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="block mt-1">
                    <Ratings rating={data?.shops?.ratings} />
                  </span>
              ...
              <button
                className="flex cursor-pointer items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 font-medium transition"
